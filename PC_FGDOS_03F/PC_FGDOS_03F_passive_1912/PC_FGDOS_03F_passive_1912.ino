...
int temperature_1, temperature_2, recharge_count_1, recharge_count_2, recharge_temp_1, recharge_temp_2;
...
void setup() {
  ...
  if (flag_isr){
    pinMode(NIRQ_1, INPUT_PULLUP); //interrupt request data ready, active low
    ...
    case 2:
      ...
      case 3:
        ...
        if ((millis()-time_start)>time_limit){
          ...
          // let the sensor auto recharge, if recharged, back to passive and break
          auto_recharge_enable(SS2);
          Serial.println("AUTO RECHARGE 2 active");
          do {
            collect_data_SS1();
            ...
            // wait at least 2 windows + 10 % for new data (in millisec: 2/WINDOW_FACTOR*1000)
            wait(2.1/WINDOW_FACTOR*1000);
          } while(recharge_temp_2 >= (recharge_count_2 & 0x7F));
