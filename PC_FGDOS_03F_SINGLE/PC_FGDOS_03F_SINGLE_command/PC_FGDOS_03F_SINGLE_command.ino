...
bool flag_print = true, flag_receive = false, flag_request = false, first_run = true, flag_recharge = true;
String command_str;
char command;
...
void setup() {
  ...
  // pin to control switch for sensor 1 power connection (passive with MOSFET) and pin to pull sensor 1 into standby
  ...
  if(Serial.available()){
      ...
      switch (command){
        ...
        case 'D':
          ...
          Serial.println("DISCHARGING CANCELLED");  
          break;
