...
void fgdos_init(byte sensor){
  ...
  byte reg_target = floor(TARGET_FREQ/WINDOW_FACTOR/1023); // dividing by 1023 is bitshifting by 10 ;)
  ...
  byte reg_threshold = floor(THRESHOLD_FREQ/WINDOW_FACTOR/1023);
